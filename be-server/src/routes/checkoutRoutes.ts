...
import { createOrder, createBootcampOrder, verifyPayment, handleWebhook } from '../controllers/checkoutController';
import { protect } from '../middlewares/authMiddleware';

const router = Router();

router.post('/create-order', protect, createOrder);
router.post('/bootcamp/create-order', protect, createBootcampOrder);
